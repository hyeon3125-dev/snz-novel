...
window.STR = (window.LANG === "en") ? {
  ...
  judgeDays: (n) => "Read " + (n === 1 ? "in 1 day." : "over " + n + " days."),
  ...
  sigils: {
    ...
    eidos: "A circle within a circle. The inner circle is slightly off-center.",
    altair: "A grid. One cell is empty. It looks as if it had been empty from the start.",
    geumhwi: "Five vertical lines. The spacing is uneven. The last line stands a little farther away.",
  },
} : {
...
if (window.LANG === "jp") window.STR = {
  ...
  judgeDays: (n) => n === 1 ? "1日で読みました。" : n + "日かけて読みました。",
